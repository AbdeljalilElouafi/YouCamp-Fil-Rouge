            ...
            <div class="px-6 py-4">
                ...
                <form action="{{ isset($tag) ? route('admin.tags.update', $tag->id) : route('admin.tags.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="{{ isset($tag) ? $tag->name : '' }}" class="mt-1 block w-full px-4 py-2 bg-white bg-opacity-10 border border-transparent rounded-md text-white focus:border-orange-500 focus:ring-orange-500" placeholder="Enter tag name">
                    </div>
